...
SC_MODULE(NoximProcessingElement)
{
    ...
    sc_in     < bool      > req_semi_rx;		// The request associated with the input channel
    sc_out    < bool      > ack_semi_rx;		// The outgoing ack signal associated with the input channel
    ...
    sc_out    < bool      > req_semi_tx;		// The request associated with the output channel
    sc_in     < bool      > ack_semi_tx;		// The outgoing ack signal associated with the output channel
